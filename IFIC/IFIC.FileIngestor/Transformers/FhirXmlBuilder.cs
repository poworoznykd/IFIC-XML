...
* DESCRIPTION   :
*   Builds CIHI FHIR-compliant XML bundles from parsed flat file data.
*   Currently supports Patient resource generation inside a Bundle for submission.
************************************************************************************/
...
{
    /// <summary>
    /// Builds FHIR XML Bundles from parsed flat files for submission to CIHI.
    /// </summary>
                ...
                new XElement(ns + "entry",
                    ...
                    new XElement(ns + "resource",
                        ...
                        new XAttribute("xmlns", ns),
                            ...
                            !string.IsNullOrWhiteSpace(healthCardNumber)
